...
class ConfigController extends Controller
{
        public function geocode_api(Request $request)
    {
        $validator = Validator::make($request->all(), [
            //lat and lng has to be exactly the same name as in our location repo 
            'lat' => 'required',
            'lng' => 'required',
        ]);
        ...
        $response = Http::get('https://maps.googleapis.com/maps/api/geocode/json?latlng='.$request->lat.','.$request->lng.'&key='."AIzaSyD-qjHDwSanKXTEiua0tHl2fV1dLcKqB-o");
        ...
        public function get_zone(Request $request)
    {
        ...
        //I commented the 2 lines below because they causing me errors. To be exact the $zones line
    ...
    public function place_api_autocomplete(Request $request)
    {
        ...
        $response = Http::get(
            ...
            .$request['search_text']
            .'&key='
            ."AIzaSyD-qjHDwSanKXTEiua0tHl2fV1dLcKqB-o"
        );
        return $response->json();
    }
