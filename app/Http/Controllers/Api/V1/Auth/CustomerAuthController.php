...
class CustomerAuthController extends Controller
{
     ...
     public function login(Request $request)
    {
          $validator = Validator::make($request->all(), [
            //Ifi want want to sign in with email i need to change phone to email
            'phone' => 'required',
        ...
        $data = [
            //I changed this to email it was phone
            'phone' => $request->phone,
        ...
        public function register(Request $request)
    {
        ...
        //We are auto generating and saving a token using larvel passport package
